...
class Hue(Ssdp):
    ...
    NLS =  "f6543a06-da50-11ba-8d8f-{hex_12}" # formatHueBridgeUUID - f6543a06-da50-11ba-8d8f-5ccf7f139f3d

    # WORK IN PROGRESS: https://github.com/originallyus/node-red-contrib-alexa-local/blob/master/index.js
    #################################
